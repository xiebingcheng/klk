...
(function(e) {
    ...
    var d = $,
        ...
        j = !1,
        f,
        mask = d('<div class="weui_mask_transparent"></div>');
    d.extend(e.prototype, {
        _init: function() {
            ...
            j || (j = !0,  d("body").append(mask), d("body").append(c), h.on("resize",
                function() {
                    setTimeout(function() {
                        a._pos()
                    }, 500)
        ...
        _cbShow: function() {
            ...
            mask.css("opacity", "1").addClass("show");
        ...
        show: function() {
            ...
            a.isShow() ? a._cbShow() : (mask.css("opacity", "0").removeClass("hide"), c.css("opacity", "0").removeClass("hide"), a._pos(), setTimeout(function() {
                a._cbShow()
        ...
        _cbHide: function() {
            ...
            mask.css("opacity", "0").addClass("hide");
            c.css("opacity", "0").addClass("hide");            
            a && a.call(this);            
        },
        hide: function() {
            var a = this;
            a.isHide() ? a._cbHide() : (mask.css("opacity", "1").removeClass("show"), c.css("opacity", "1").removeClass("show"), setTimeout(function() {
                a._cbHide()
            }, 300), setTimeout(function() {
                mask.animate({
                    opacity: "0"
