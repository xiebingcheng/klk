...
method.listData = function(date) {
	$.ajax({
		url: "/news/index.php?m=index&c=index&a=kaijiang&type=getBaseCQShiCaiList&date=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
	...
	if(data.errorCode == 0) {
		if(data.result.businessCode == 0) {
			...
			$(data).each(function() {
				...
				if(sumBigSamll == "大") {
					divhtml += "<li style='color:#f12d35'>" + sumBigSamll + "</li>";
				} else {
					divhtml += "<li style='color:#184dd5'>" + sumBigSamll + "</li>";
				}
				if(sumSingleDouble == "双") {
					divhtml += "<li style='color:#f12d35'>" + sumSingleDouble + "</li>";
				} else {
					divhtml += "<li style='color:#184dd5'>" + sumSingleDouble + "</li>";
				}
				if(dragonTiger == "龙") {
					divhtml += "<li style='color:#f12d35'>" + dragonTiger + "</li>";
				} else if(dragonTiger == "和") {
					divhtml += "<li style='color:#00ab07 '>" + dragonTiger + "</li>";
				} else {
					divhtml += "<li style='color:#184dd5'>" + dragonTiger + "</li>";
				}
				if(tools.typeOf("san", this.behindThree) == "对子") {
					divhtml += "<li style='color:#f12d35'>" + tools.typeOf("san", this.behindThree) + "</li>";
				} else {
					divhtml += "<li style='color:#184dd5'>" + tools.typeOf("san", this.behindThree) + "</li>";
				}
				if(tools.typeOf("san", this.betweenThree) == "对子") {
					divhtml += "<li style='color:#f12d35'>" + tools.typeOf("san", this.betweenThree) + "</li>";
				} else {
					divhtml += "<li style='color:#184dd5'>" + tools.typeOf("san", this.betweenThree) + "</li>";
				}
				if(tools.typeOf("san", this.lastThree) == "对子") {
					divhtml += "<li style='color:#f12d35'>" + tools.typeOf("san", this.lastThree) + "</li>";
				} else {
					divhtml += "<li style='color:#184dd5'>" + tools.typeOf("san", this.lastThree) + "</li>";
				}
				divhtml += '</ul>';
				divhtml += '</div>';
				divhtml += '</div>';
