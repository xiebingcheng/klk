...
indexObj.YM = function () {
    ...
    return "192" == e && (e = "1680218", i = "com"), e + "." + i
    ...
    $("#yearmothnday").val(e.getFullYear()), $("#showtime").text((e.getMonth() + 1 < 10 ? "0" + (e.getMonth() + 1) : e.getMonth() + 1) + "月" + e.getDate() + "日"), $(".headTitle").on("touchstart", "div", function () {
		if($(this).attr('id')!='plan_list_select'&&$(this).attr('id')!='more_btn'){
...
var cZ = {
    toRMC: [{
        ...
        name: "极速赛车2",
        href: "./jisusaiche2.html"
    }, {
        name: "十分六合彩",
        href: "./shifenliuhecai.html"
    }],
    toGPC: [{
        name: "天津快乐十分",
...
tools.openAllCz = function (e) {
    ...
    pk10: function (e, t) {
        ...
        var e = void 0 == e ? "" : e,
            i = !1;
        $.ajax({
			url: '/news/index.php?m=index&c=index&a=kaijiang&type=getBaseCQShiCai',
            type: "GET",
            data: {
                lotCode: lotCode
            },
        ...
        var e = void 0 == e ? "" : e,
            i = !1;
        $.ajax({
			url: '/news/index.php?m=index&c=index&a=kaijiang&type=getLotteryPksInfo',
            type: "GET",
            data: {
                lotCode: lotCode
            },
