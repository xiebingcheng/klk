...
function() {
    ...
    b.fn.pause = function() {
        return this.each(function() {
            this[c] || (this[c] = d++);
            var e = f[this[c]];
            e && e.run && (e.done += a() - e.start, e.done > e.opt.duration ? delete f[this[c]] : (b(this).stop(), b(this).stop(), b(this).stop(), b(this).stop(), b(this).stop(), e.run = !1))
        })
    },
    ...
    var c = function(b, c) {
        ...
        this.$timer.timer({
            ...
            callback: function(i) {
                ...
                var j = 0,
                k = a(b).data("nowTime")[(parseInt(a(b).data("nowTime")) - 30).toString()];
                if (k) {
                    for (var l in k) 0 == k[l].position && (j += 1);
                    for (; j;) h.shift(),
                    j -= 1
                }
                g = parseInt(e / c.FontSizeBig),
                d.options.SubtitleProtection && (g -= 3),
                e = a(b).height(),
                f = a(b).width();
                var m = parseInt(f / (672 / c.speed));
                if (a(b).data("danmuList")[a(b).data("nowTime")]) for (var n = a(b).data("danmuList")[a(b).data("nowTime")], l = n.length-1; l < n.length; l++) {
                    var o = "<div class='danmaku' id='" + d.id + "tempDanmaku'></div>";
                    if (a(b).append(o), a("#" + d.id + "tempDanmaku").text(n[l].text), a("#" + d.id + "tempDanmaku").css({
                        color: n[l].color,
                    ...
                    }), n[l].color < "#777777" && a("#" + d.id + "tempDanmaku").css({
                        "text-shadow": " 0px 0px 2px #FFFFFF"
                    }), n[l].hasOwnProperty("isnew") && a("#" + d.id + "tempDanmaku").css({
                        border: "2px solid " + n[l].color
                    }), 0 == n[l].size && a("#" + d.id + "tempDanmaku").css("font-size", c.fontSizeSmall), 0 == n[l].position) {
                        var p = parseInt(g);
                        d.options.positionOptimize && (p = parseInt(g / 2));
                        for (var q = parseInt(p * Math.random());  h.length < g;) q = (q + 1) % g;
                        h.push(q),
                        h.length >= g && (h = []);
                        var r = q * c.FontSizeBig,
                        s = parseInt(10 * Math.random()),
                        t = s + a(this).width();
                        a("#" + d.id + "tempDanmaku").css({
                            position: "absolute",
                            top: r,
                            left: t
                        });
                        var u = d.id + "fly" + parseInt(e * Math.random()).toString();
                    ...
                    } else if (1 == n[l].position) {
                        var v = d.id + "top" + parseInt(1e4 * Math.random()).toString();
                        ...
                        a("#" + v).fadeTo(c.topBottonDanmuTime, a(b).data("opacity"),
                        function() {
                            a(this).remove(),
                            $("#danmu").empty(),
                    ...
                    } else if (2 == n[l].position) {
                        var w = d.id + "bottom" + parseInt(1e4 * Math.random()).toString();
                        a("#" + d.id + "tempDanmaku").attr("id", w),
                        a("#" + w).css({
                            width: c.width,
                            "text-align": "center",
                            position: "absolute",
                        ...
                        a("#" + w).fadeTo(c.topBottonDanmuTime, a(b).data("opacity"),
                        function() {
                            a(this).remove(),
                            a(b).data("bottomSpace", a(b).data("bottomSpace") - c.FontSizeBig)
                        })
